...
export class CashRegister {
  ...
  get openedBy(): string { return this.props.openedBy; }
  ...
  get finalAmount(): Money | undefined { return this.props.finalAmount; }
  get expectedAmount(): Money | undefined { return this.props.expectedAmount; }
  get difference(): Money | undefined { return this.props.difference; }
  get status(): CashRegisterStatus { return this.props.status; }
  ...
  hasDifference(): boolean {
    return this.props.difference !== undefined && !this.props.difference.isZero();
  }
