import { CashRegister, CashRegisterProps } from '../../domain/entities/CashRegister';
...
export class OpenCashRegisterUseCase {
  ...
  async execute(dto: OpenCashRegisterDTO): Promise<CashRegister> {
    ...
    const openRegister = await this.cashRegisterRepository.findOpenRegister(dto.clinicId);
