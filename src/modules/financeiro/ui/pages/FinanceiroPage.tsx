...
export function FinanceiroPage() {
  ...
  const { totalReceitas, totalDespesas, receitasPendentes, despesasPendentes, saldo } = useTransactions();
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Pendentes: {new Intl.NumberFormat('pt-BR', {
                style: 'currency',
                currency: 'BRL',
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <p className={`text-xl font-bold ${cashFlow.saldo >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                        {new Intl.NumberFormat('pt-BR', {
                          style: 'currency',
                          currency: 'BRL',
