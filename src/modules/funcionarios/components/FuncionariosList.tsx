...
import { Funcionario, FuncionarioFilters, cargosDisponiveis } from '../types/funcionario.types';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function FuncionariosList({ funcionarios, onEdit, onDelete, onView, onAdd }: FuncionariosListProps) {
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div className="flex flex-col sm:flex-row gap-3 flex-1 w-full sm:w-auto">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFilters({ ...filters, cargo: value === 'all' ? undefined : value })
            }
          >
                ...
                <TableRow key={funcionario.id}>
                  ...
                  <TableCell>
                    <div className="text-sm">
                      ...
                      <div className="text-muted-foreground text-xs">{funcionario.email}</div>
                    </div>
                  </TableCell>
                  <TableCell>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir este funcionário? Esta ação não pode ser desfeita e removerá todos os acessos e permissões.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
