...
export function CampaignCard({ campaign, onActivate, onPause, onComplete, onViewDetails }: CampaignCardProps) {
        ...
        {campaign.metrics && (
          <div className="grid grid-cols-3 gap-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold">{campaign.metrics.totalSent}</p>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold">{campaign.metrics.totalOpened}</p>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold">{campaign.getOpenRate().toFixed(1)}%</p>
        ...
        <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
          ...
          {campaign.startDate && (
            <div>
              ...
              {format(campaign.startDate, "dd/MM/yyyy 'às' HH:mm", { locale: ptBR })}
            </div>
          )}
          {campaign.endDate && (
            <div>
              <strong>Finalizado:</strong>{' '}
              {format(campaign.endDate, "dd/MM/yyyy 'às' HH:mm", { locale: ptBR })}
            </div>
          )}
        </div>
      </CardContent>
