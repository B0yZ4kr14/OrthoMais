...
export function MarketingAutoPage() {
  const { campaigns, loading, createCampaign, activateCampaign, pauseCampaign, completeCampaign, totalCampaigns, activeCampaigns, draftCampaigns, completedCampaigns } = useCampaigns();
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Automação de Marketing</h1>
