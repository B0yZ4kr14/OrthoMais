...
import type { Produto } from '@/modules/estoque/domain/entities/Produto';
              ...
              <div className="space-y-2 mb-4">
                <div className="flex justify-between text-sm">
                  ...
                  <span className={`font-medium ${
                    estoqueZerado ? 'text-destructive' :
                    estoqueBaixo ? 'text-warning' :
                    'text-foreground'
                  }`}>
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span>{produto.quantidadeMinima} {produto.unidadeMedida}</span>
                </div>
                <div className="flex justify-between text-sm">
