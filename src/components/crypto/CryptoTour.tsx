    ...
    },
    {
      ...
      content: (
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Primeiro, configure uma exchange (Binance, Coinbase, etc.) onde você receberá
            as criptomoedas.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Depois, crie carteiras para cada tipo de criptomoeda que deseja aceitar
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Use a calculadora para converter entre criptomoedas e BRL em tempo real
            com as cotações atualizadas.
          </p>
        </div>
      ),
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Com as carteiras configuradas, você pode gerar QR Codes para seus pacientes
            pagarem diretamente em criptomoedas!
          </p>
        </div>
      ),
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Configure alertas de preço para ser notificado quando for o melhor momento
            para converter suas criptomoedas em BRL.
          </p>
        </div>
      ),
      disableBeacon: true,
