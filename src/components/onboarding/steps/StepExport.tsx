  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          Parabéns! Você concluiu o tour de onboarding. Agora está pronto para começar 
          a usar o Ortho+ com confiança.
        </AlertDescription>
      </Alert>
      ...
      <Card className="p-6 bg-muted/50">
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>Tour Guiado:</strong> Você pode iniciar o tour novamente a qualquer momento
              clicando no botão de ajuda no canto superior direito
            </span>
          </li>
          <li className="flex items-start gap-2">
            <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
            <span>
              <strong>Documentação:</strong> Acesse a documentação completa do sistema 
              para guias detalhados de cada módulo
            </span>
          </li>
          <li className="flex items-start gap-2">
            <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
            <span>
              <strong>Suporte:</strong> Em caso de dúvidas, entre em contato com o 
              suporte técnico da TSI Telecom
            </span>
          </li>
        </ul>
      </Card>
