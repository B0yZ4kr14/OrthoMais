      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="mt-6 p-4 rounded-lg bg-primary/5 border border-primary/20">
          <p className="text-xs text-muted-foreground text-center">
            <strong>Dica:</strong> No Windows/Linux use <Badge variant="outline" className="mx-1 font-mono text-xs">Ctrl</Badge> 
            ao invés de <Badge variant="outline" className="mx-1 font-mono text-xs"><Command className="h-3 w-3 inline" /></Badge>
          </p>
        </div>
      </DialogContent>
    </Dialog>
