  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-xl font-bold text-foreground">Roadmap de Adoção Inteligente</h3>
          ...
          <AlertDescription>
            <div className="grid grid-cols-4 gap-4 text-sm">
              <div>
                ...
                <span className="ml-2 font-semibold">{clinicProfile.patient_count}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Dias de uso:</span>
                <span className="ml-2 font-semibold">{clinicProfile.days_since_creation}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Módulos ativos:</span>
                <span className="ml-2 font-semibold">{clinicProfile.active_modules_count}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Disponíveis:</span>
                <span className="ml-2 font-semibold">{clinicProfile.inactive_modules_count}</span>
              </div>
            </div>
          </AlertDescription>
        </Alert>
